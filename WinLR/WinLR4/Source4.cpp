...
#define PATH L"C:\\Users\\lesh7\\OneDrive\\Рабочий стол\\ВИНАПИ\\WinLR1\\WinLR4\\test.txt"
	...
	int mode) 		// Режим отображения окна
{
	...
	AppendMenu(hmenu1, MF_STRING | MF_POPUP, (UINT)hPopupMenu, L"&Запуск потоков");
	{
		AppendMenu(hPopupMenu, MF_STRING, 1000, L"Таблица");
		AppendMenu(hPopupMenu, MF_STRING, 1001, L"Диаграмма");
	}
	HMENU hPopupMenu1 = CreatePopupMenu();
	AppendMenu(hmenu1, MF_STRING | MF_POPUP, (UINT)hPopupMenu1, L"&Выключение потоков");
	{
		AppendMenu(hPopupMenu1, MF_STRING, 1002, L"Таблица");
		AppendMenu(hPopupMenu1, MF_STRING, 1003, L"Диаграмма");
	}
